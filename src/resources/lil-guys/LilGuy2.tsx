...
interface LilGuy2Props {
    fillColor: string;
}

const LilGuy2: React.FC<LilGuy2Props> = ({ fillColor }) => {
    return (
        <svg
            fill={fillColor}
            version="1.1"
        ...
        >
            <g>
                <path
                    d="M56.033,0C25.136,0,0,25.136,0,56.034c0,30.894,25.136,56.032,56.032,56.032c30.895,0,56.033-25.139,56.033-56.032
